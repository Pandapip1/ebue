...
/* ==== Tier 4: "bigger engines" -- archive/content-format utilities ======
 *
 * pax(1p), ar(1p), file(1p): same reasoning as every Tier above --
 * each also exists as a real standalone obj/bin/<name>.exe
