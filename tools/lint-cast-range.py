...
"""Check the Clang range-checker's fixtures and live findings."""
...
def main() -> int:
    ...
    if findings:
        print(f"lint-cast-range: {len(findings)} finding(s)")
        return 1
    print("lint-cast-range: no findings (fixtures passed)")
    return 0
