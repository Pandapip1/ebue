...
#if 0 /* UNIMPL: glob.html basic match + default sort order, see above */
static void test_glob_basic_and_sort(void)
{
	glob_t g;

	/* three files b.txt, a.txt, c.txt exist in the cwd for this test;
	 * setup/teardown via creat()/unlink() omitted from this sketch */
...
#if 0 /* UNIMPL: glob.html GLOB_NOCHECK, see above */
...
#if 0 /* UNIMPL: glob.html GLOB_APPEND, see above */
...
#if 0 /* UNIMPL: glob.html GLOB_DOOFFS, see above */
...
#if 0 /* UNIMPL: glob.html GLOB_MARK, see above */
 ...
 * readdir(), or stat()). */
#if 0 /* UNIMPL: glob.html GLOB_ERR/errfunc, see above */
...
static void test_glob_err_callback(void)
{
	 ...
	 * e.g. via chmod(dir, 0) beforehand */
	glob_err_seen = 0;
...
#if 0 /* UNIMPL: glob.html GLOB_NOESCAPE, see above */
...
#if 0 /* UNIMPL: glob.html GLOB_NOSPACE / globfree, see above */
